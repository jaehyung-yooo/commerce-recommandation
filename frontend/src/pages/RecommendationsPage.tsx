      ...
      setRecommendations([
        {
          ...
          price: 1500000,
          rating: 4.8,
          image: 'https://via.placeholder.com/200x200/3B82F6/FFFFFF?text=MacBook+Air+M3',
          category: 'electronics',
          description: '당신의 구매 이력을 바탕으로 추천',
        ...
        },
        {
          ...
          price: 1400000,
          rating: 4.7,
          image: 'https://via.placeholder.com/200x200/6B7280/FFFFFF?text=iPad+Pro+12.9',
          category: 'electronics',
          description: '유사한 고객들이 선택한 상품',
        ...
        },
        {
          ...
          price: 650000,
          rating: 4.6,
          image: 'https://via.placeholder.com/200x200/8B5CF6/FFFFFF?text=AirPods+Max',
          category: 'electronics',
          description: '최근 관심 카테고리 기반 추천',
        ...
        },
        {
          ...
          price: 500000,
          rating: 4.5,
          image: 'https://via.placeholder.com/200x200/10B981/FFFFFF?text=Apple+Watch+Series+9',
          category: 'electronics',
          description: 'AI가 분석한 맞춤 상품',
